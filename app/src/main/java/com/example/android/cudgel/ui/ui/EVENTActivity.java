...
public class EVENTActivity extends ActionBarActivity {
    ...
    private void processDowloadandSQLinsert(  ){
        ...
        dialog= ProgressDialog.show(EVENTActivity.this, "Please Wait", "downloading latest data from server...", true);
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> parseObject, ParseException e) {
                if (e == null) {
                    ...
                    adapter = new CustomAdapter(EVENTActivity.this, parseObject);
                    ...
                    Toast.makeText(EVENTActivity.this, "Error to fetch details !!!", Toast.LENGTH_SHORT).show();
    ...
    class CustomAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            txtMob.setText(result.get(position).getString("Date").trim());
